  ...
  <section>
    ...
    <div class="content">
      <div class="cell box-row align-center justify-space-around">
        <span class="cell-left">宣讲单位：</span>
        <div class="cell-right box-row align-center justify-space-between" @click="showOrgPicker">
      ...
      <div class="cell box-row align-start justify-space-around">
        <span class="cell-left">留言备注：</span>
...
export default {
  ...
  created() {
    ...
    this.xj_id = sessionStorage.getItem("XJ_ID") || this.$route.params.ID;
    Promise.all([
      this.getTownsData(),
      this.getOrgData(),
      this.$axios.http({
  ...
  methods: {
    ...
    submit() {
      ...
      this.$axios
        .http({
          url: "/jfqwmsj/api/xq/add",
          data: {
            openid: this.openid,
            xj_id: this.xj_id,
            xj_code: this.org.code,
            name: this.name,
            phone: this.phone,
